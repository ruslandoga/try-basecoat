defmodule BasecoatWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BasecoatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BasecoatWeb.Gettext, "errors", msg, opts)
    end
  end
